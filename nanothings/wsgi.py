...
"""
WSGI config for nanothings project.
...
# os.environ["DJANGO_SETTINGS_MODULE"] = "userinterface.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "nanothings.prod_settings")
